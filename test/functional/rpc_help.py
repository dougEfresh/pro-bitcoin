    ...
    def test_client_conversion_table(self):
        ...
        for argname, convert in converts_by_argname.items():
            if all(convert) != any(convert):
                ...
                assert_equal(argname, 'dummy', ('WARNING: conversion mismatch for argument named %s (%s)' % (argname, list(zip(all_methods_by_argname[argname], converts_by_argname[argname])))))
