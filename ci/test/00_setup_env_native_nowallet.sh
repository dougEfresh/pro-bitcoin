...
export PACKAGES="python3-zmq clang-5.0 llvm-5.0 gpg software-properties-common zlib1g-dev libcurl4-openssl-dev"  # Use clang-5 to test C++17 compatibility, see doc/dependencies.md
