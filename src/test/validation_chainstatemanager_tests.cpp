...
BOOST_FIXTURE_TEST_CASE(chainstatemanager_activate_snapshot, TestChain100Setup)
{
    ...
    auto p = fs::PathFromString(m_path_root.string());
    BOOST_REQUIRE(!CreateAndActivateUTXOSnapshot(m_node, p));
    ...
    BOOST_REQUIRE(!CreateAndActivateUTXOSnapshot(
        m_node, p, [](CAutoFile& auto_infile, SnapshotMetadata& metadata) {
